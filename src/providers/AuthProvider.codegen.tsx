...
`;
export type AuthUserComponentProps = Omit<
  ...
  'query'
> &
  ({variables: AuthUserQueryVariables; skip?: boolean} | {skip: boolean});

export const AuthUserComponent = (props: AuthUserComponentProps) => (
  <ApolloReactComponents.Query<AuthUserQuery, AuthUserQueryVariables>
...
>;
export type RemoveUserMutationResult = Apollo.MutationResult<
  RemoveUserMutation
>;
