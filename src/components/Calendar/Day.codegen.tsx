  ...
  user: {
    ...
    calendarDay: Array<{
      ...
      notes?: Types.Maybe<{
        ...
        order?: Types.Maybe<string>;
      }>;
      events?: Types.Maybe<{
        __typename?: 'Events';
        event?: Types.Maybe<string>;
...
`;
export type CalendarDayComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<
    CalendarDayQuery,
    CalendarDayQueryVariables
  >,
  'query'
> &
  ({variables: CalendarDayQueryVariables; skip?: boolean} | {skip: boolean});

export const CalendarDayComponent = (props: CalendarDayComponentProps) => (
  <ApolloReactComponents.Query<CalendarDayQuery, CalendarDayQueryVariables>
    query={CalendarDayDocument}
    {...props}
  />
);
 ...
 * });
 */
export function useCalendarDayQuery(
  ...
  return Apollo.useQuery<CalendarDayQuery, CalendarDayQueryVariables>(
    CalendarDayDocument,
    options,
  );
}
export function useCalendarDayLazyQuery(
  ...
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useLazyQuery<CalendarDayQuery, CalendarDayQueryVariables>(
    CalendarDayDocument,
    options,
  );
}
export type CalendarDayQueryHookResult = ReturnType<typeof useCalendarDayQuery>;
export type CalendarDayLazyQueryHookResult = ReturnType<
  typeof useCalendarDayLazyQuery
>;
export type CalendarDayQueryResult = Apollo.QueryResult<
  CalendarDayQuery,
  CalendarDayQueryVariables
>;
